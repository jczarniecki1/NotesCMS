...
fontFamilyOptions = [
  {
    ...
    name: 'Helvetica',
    value: 'Helvetica Neue, Helvetica, Noto Sans, Arial, sans-serif'
  }, {
    name: 'Philosopher',
  ...
  function Layout(noteFactoryService) {
    return {
      ...
      link: function(scope, element) {
        ...
        scope.allNotes = JSON.parse(localStorage.allNotes || "0") || [noteFactoryService.fakeNote(), noteFactoryService.fakeNote(), noteFactoryService.fakeNote(), noteFactoryService.fakeNote(), noteFactoryService.fakeNote(), noteFactoryService.fakeNote(), noteFactoryService.fakeNote(), noteFactoryService.fakeNote()];
        ...
        if (localStorage.fontFamily) {
          ...
          return scope.user.fontFamily = 2;
        }
      }
    };
  }
